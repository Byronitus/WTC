    ...
    for x in range(min_x - 1, max_x + 2):
        for y in range(min_y - 1, max_y + 2):
            if (x == min_x - 1 or x == max_x + 1 or 
                ...
                ob_list.append((x * 5, y * 5))
    ob_list.remove(((min_x - 1) * 5,(random.randrange(min_y + 1, max_y - 1, 2)) * 5))
    ob_list.remove(((max_x + 1) * 5,(random.randrange(min_y + 1, max_y - 1, 2)) * 5))
    ob_list.remove(((random.randrange(min_x + 1, max_x - 1, 2)) * 5, (min_y - 1) * 5))
    ob_list.remove(((random.randrange(min_x + 1, max_x - 1, 2)) * 5, (max_y + 1) * 5))
